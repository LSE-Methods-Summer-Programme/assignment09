...
1.  Explore the ability to subset a corpus.  
    ...
    obamadfm <- dfm(corpus_subset(data_corpus_inaugural, President=="Obama"), remove = stopwords("english"), remove_punct = TRUE)
    textplot_wordcloud(obamadfm)    
    obamadfm <- dfm(corpus_subset(data_corpus_inaugural, President=="Trump"), remove = stopwords("english"), remove_punct = TRUE)
    textplot_wordcloud(obamadfm)
    ```
